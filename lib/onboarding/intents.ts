...
const SIGNALS: ReadonlyArray<readonly [OnboardingIntent, readonly string[]]> = [
  [
    "family_office",
    ["family office", "estate", "trust fund", "trusts", "generational wealth", "wealth manager"],
  ],
  [
    "investor",
    [
  ...
  [
    "teacher",
    ["teacher", "i teach", "teaching", "professor", "educator", "classroom", "my students"],
  ],
  [
    "renter",
    ["rent ", "renter", "renting", "i rent", "apartment", "tenant", "my lease", "landlord"],
  ],
  [
    "traveler",
    [
