  ...
  return (
    <Drawer.Root open={open} onOpenChange={onOpenChange} repositionInputs={false}>
      <Drawer.Portal>
        ...
        <Drawer.Content
          className="fixed inset-x-0 bottom-0 z-[110] mx-auto flex max-h-[92vh] w-full flex-col rounded-t-2xl border border-line bg-surface-floating outline-none sm:bottom-4 sm:max-w-md sm:rounded-2xl"
        >
